...
* **Market Ingestion Service**: Polls and streams mark prices, orderbooks, and open interest from Hyperliquid, Aevo, and Lighter.xyz. Funding rates come only from exchange-confirmed history endpoints.
...
* **WebSocket Server**: Pushes real-time liquidity updates and confirmed-history opportunities to the frontend.
...
1. **Phase 1 (Backend API & WebSocket)**: Wrap the scanner into a FastAPI service broadcasting live liquidity and confirmed-history opportunities via WebSocket.
